...
import { LayoutDashboard, ChartBar, Gauge, ShoppingBag, GraduationCap, Forklift, Search, Banknote } from "lucide-react";
...
const searchItems = [
  ...
  { group: "Dashboards", icon: Banknote, label: "Rewards" },
